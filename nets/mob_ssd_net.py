...
_CONV_DEFS = [
    ...
    DepthSepConv(kernel=[3, 3], stride=1, depth=512), # 28 * 28 9
    DepthSepConv(kernel=[3, 3], stride=1, depth=512), # 28 * 28 10
    DepthSepConv(kernel=[3, 3], stride=1, depth=512), # 28 * 28 11
    DepthSepConv(kernel=[3, 3], stride=2, depth=1024),# 14 * 14 12
    DepthSepConv(kernel=[3, 3], stride=1, depth=1024) # 14 * 14 13
]
class Mobilenet_SSD_Face(object):
    ...
    def __init__(self, params=None):
        ...
        if isinstance(params, SSDParams):
            ...
            self.params = Mobilenet_SSD_Face.default_params
    ...
    def net(self, inputs,
        ...
        """
        r = mobilenet_ssd_face_net(inputs,
    ...
    def arg_scope(self, weight_decay=0.0005, data_format='NHWC', is_training= True):
        """Network arg_scope.
        """
        return mobilenet_ssd_face_arg_scope( is_training=is_training, weight_decay = weight_decay, data_format=data_format)
...
def mobilenet_ssd_face_net(inputs,
                            num_classes=Mobilenet_SSD_Face.default_params.num_classes,
                            feat_layers=Mobilenet_SSD_Face.default_params.feat_layers,
                            anchor_sizes=Mobilenet_SSD_Face.default_params.anchor_sizes,
                            anchor_ratios=Mobilenet_SSD_Face.default_params.anchor_ratios,
                            normalizations=Mobilenet_SSD_Face.default_params.normalizations,
...
mobilenet_ssd_face_net.default_image_size = 440

def mobilenet_ssd_face_arg_scope(is_training=True,
